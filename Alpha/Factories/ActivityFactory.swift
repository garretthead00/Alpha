...
struct ActivityFactory {
    ...
    func makeTargetHandler(target: UserTarget) -> TargetHandler? {
        switch target.id {
            case .EnergyBurned:         return TargetHandler(target: target, name: "Energy Burned", description :"", icon: UIImage(named:"EnergyBurned")!, unit: UnitEnergy.calories)
            case .Steps:                return TargetHandler(target: target, name: "Steps", description :"", icon: UIImage(named:"Steps")!, unit: UnitCount.steps)
            case .Distance:             return TargetHandler(target: target, name: "Distance", description :"", icon: UIImage(named:"Distance")!, unit: UnitLength.meters)
            case .WorkoutsCompleted:    return TargetHandler(target: target, name: "Workouts", description :"", icon: UIImage(named:"WorkoutsCompleted")!, unit: UnitCount.workouts)
            case .ExerciseMinutes:      return TargetHandler(target: target, name: "Exercise Minutes", description :"", icon: UIImage(named:"ExerciseMinutes")!, unit: UnitDuration.minutes)
            case .EnergyConsumed:       return TargetHandler(target: target, name: "Energy Consumed", description :"", icon: UIImage(named:"EnergyConsumed")!, unit: UnitEnergy.calories)
            case .Protein:              return TargetHandler(target: target, name: "Protein", description :"", icon: UIImage(named:"Protein")!, unit: UnitMass.grams)
            case .Carbohydrates:        return TargetHandler(target: target, name: "Carbohydrates", description :"", icon: UIImage(named:"Carbohydrates")!, unit: UnitMass.grams)
            case .Fat:                  return TargetHandler(target: target, name: "Fat", description :"", icon: UIImage(named:"Fat")!, unit: UnitMass.grams)
            case .Water:                return TargetHandler(target: target, name: "Water", description :"", icon: UIImage(named:"Water")!, unit: UnitVolume.liters)
            case .SleepMinutes:         return TargetHandler(target: target, name: "Sleep Minutes", description :"", icon: UIImage(named:"SleepMinutes")!, unit: UnitDuration.minutes)
            case .MindfulMinutes:       return TargetHandler(target: target, name: "Mindful Minutes", description :"", icon: UIImage(named:"MindfulMinutes")!, unit: UnitDuration.minutes)
            default : return nil
        }
